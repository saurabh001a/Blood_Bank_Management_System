<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADMIN_SEARCH.aspx.cs" Inherits="BLOOD_BANK_MANAGEMENT_SYSTEM.WebForm6" %>
...
<head runat="server">
    ...
    <style>
        ...
        #HyperLink2:visited, #HyperLink3:visited {
            color: #0000FF;
        }
            ...
            <div class="content">
                <div class="content1">
                    <ul style="display: flex; align-items: center; justify-content: space-evenly; padding: 0; margin: 0; list-style-type: none;">
                        ...
                        <li>
                            <asp:HyperLink ID="HyperLink1" runat="server" href="ADMIN_SEARCH.aspx" class="active">SEARCH DONAR</asp:HyperLink>
                        </li>
                        <li>
