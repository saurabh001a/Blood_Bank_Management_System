<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ACCEPTOR_REGISTRATION.aspx.cs" Inherits="BLOOD_BANK_MANAGEMENT_SYSTEM.WebForm4" %>
...
<head runat="server">
    ...
    <style>
        ...
        #HyperLink1:visited, #HyperLink2:visited, #HyperLink3:visited {
            color: #0000FF;
        }
            ...
            <div class="content">
                <div class="content1">
                    <ul style="display: flex; align-items: center; justify-content: space-evenly; padding: 0; margin: 0; list-style-type: none;">
                        ...
                        <li>
                            <asp:HyperLink ID="HyperLink4" runat="server" href="ACCEPTOR_REGISTRATION.aspx" class="active">REQUEST BLOOD</asp:HyperLink>
                        </li>
                        <li>
                    ...
                    <div class="form">
                        <div class="form_data">
                            ...
                            <table cellpadding="10">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label6" runat="server" Text="Label">SELECT GENDER:</asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label3" runat="server" Text="Label">REQUEST FOR:</asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label7" runat="server" Text="Label">PACK:</asp:Label>
                                    </td>
                                    <td>
